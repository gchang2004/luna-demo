...
return (
  <motion.div className="bg-white"
    ...
    <main className="py-60 sm:py-56">
        ...
        {/* 404 Error */}
        <motion.p className="text-base font-semibold text-indigo-600 mb-2" variants={textMotion}>
            404
        </motion.p>
        ...
        {/* Error Message */}
        <motion.h1 className="mt-4 text-3xl font-semibold tracking-tight text-gray-900 sm:text-5xl" variants={textMotion}>
            Page not found
        </motion.h1>
